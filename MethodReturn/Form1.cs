...
namespace MethodReturn
{
    public partial class Form1 : Form
    {
        ...
        private void testButton_Click(object sender, EventArgs e)
        {
            ...
            q2Output.Text = $"The area is {result} units squared";
            ...
            int prints = Convert.ToInt32(copiesInput.Text);

            double cost = PrintPrice(prints);
            q3Output.Text = $"The total price is {cost.ToString("C")}";
        }
